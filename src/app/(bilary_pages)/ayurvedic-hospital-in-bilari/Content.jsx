      ...
      <section className="py-16 px-6">
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-10">
          ...
          <div className="flex-1 order-1">
            ...
            {/* Section 1 — Ayurvedic Hospital in Bilari */}
            <div className="mb-12">
            ...
            <div className="mb-12">
              <h2 className="text-3xl font-serif mb-4 text-gray-900">
                Why Balprada Is Based in Bilari
              </h2>

              <p className="text-gray-700 mb-4">
                Bilari's quieter, more rural setting was chosen specifically to support the kind of disciplined, distraction-free environment that Ayurvedic healing traditionally requires.
              </p>
            ...
            <div className="mb-12 bg-[#F8F4EA] text-black rounded-2xl p-8">
              ...
              <ul className="text-black space-y-2 mb-6 list-disc pl-5">
                <li>Patients interested in exploring Ayurvedic treatment for their health concerns can book a consultation at Balprada Ayurvedic Hospital &amp; Research Center in Bilari, Moradabad.</li>
                ...
                <li>For patients traveling from outside Bilari, the hospital also assists with treatment planning to accommodate multi-day Panchakarma therapy schedules.</li>
                <li>Daily OPD is available from 10:00 AM to 2:00 PM, seven days a week, with free consultation on the 15th of every month.</li>
              </ul>
