...
export default async function PathologyTestPage({ params }) {
  ...
  return <Shell>
    ...
    <section className="section-band detail-band clinical-detail">
      <div><p className="eyebrow">Test Information</p><h2>Simple preparation, dependable support</h2><div className="sample-badge"><small>Sample required</small><strong>{test.sample}</strong></div></div>
